...
<template>
  <div class="inline-grid grid-cols-12 grid-rows-1 w-screen min-h-screen">
    <button @click="decrement" class="cursor-pointer duration-200 hover:scale-125 active:scale-100 justify-self-start m-2 z-10" title="Go Back">
      <svg xmlns="http://www.w3.org/2000/svg" width="25px" height="25px" viewBox="0 0 24 24" class="stroke-gray-200">
        <path stroke-linejoin="round" stroke-linecap="round" stroke-width="1.5" d="M11 6L5 12M5 12L11 18M5 12H19"></path>
      </svg>
    </button>

    <Transition mode="out-in" :name="direction === 'forward' ? 'slide-left' : 'slide-right'">
      <component :is="currentInfo" class="col-span-10 row-span-1 content-center justify-items-center justify-self-center"></component>
    </Transition>
